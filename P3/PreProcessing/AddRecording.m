...
varNames = {'Mouse', 'Acq', 'Vessel', 'Group', 'Depth', 'nx', 'ny', 'ny_extra', 'height', 'width', 'Acq Freq', 'FrameRateHz', 'Comments', 'RawDataFolder', 'DataFolder'};
...
for ind = 1:size(Acquisitions,1)
    ...
    info_parameters = {'Vessel', 'Group', 'Depth', 'nx', 'ny', 'ny_extra', 'height', 'width', 'Acq Freq', 'FrameRateHz', 'Comments'};
